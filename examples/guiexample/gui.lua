...
function Widget:OnAction()
	print(self.name .. " OnAction")
end
function Widget:OnKeyPress()
	print(self.name .. " OnKeyPress")
...
function Widget:OnAlternateClick()
	print(self.name .. " OnAlternateClick")
end
function Widget:OnHover()
	print(self.name .. " OnHover")
end
function Widget:OnHoverExit()
	print(self.name .. " OnHoverExit")
end
